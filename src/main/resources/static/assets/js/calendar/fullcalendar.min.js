    ...
    return function (t) {
        ...
        var l = n(2), u = n(4), d = n(42), c = function (t) {
            ...
            return l.__extends(e, t), e.prototype.renderFgSegs = function (t) {
                ...
                return '<a class="' + f.join(" ") + '"' + (d.onclick ? ' onclick="' + u.htmlEscape(d.onclick) + '"' : "") + (d.url ? ' href="' + u.htmlEscape(d.url) + '"' : "") + (g ? ' style="' + g + '"' : "") + '><div class="fc-content">' + (n ? '<div class="fc-time" data-start="' + u.htmlEscape(r) + '" data-full="' + u.htmlEscape(i) + '"><span>' + u.htmlEscape(n) + "</span></div>" : "") + (d.title&&d.htitle ? '<div class="fc-title" title="11'+ u.htmlEscape(d.htitle) + '">' + u.htmlEscape(d.title) + "</div>" :(d.title ? '<div class="fc-title">' + u.htmlEscape(d.title) + "</div>" : "")) + '</div><div class="fc-bg"/>' + (h ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
        ...
        var o = n(2), s = n(3), a = n(4), l = n(42), u = function (t) {
            ...
            return o.__extends(e, t), e.prototype.renderBgRanges = function (e) {
                ...
                // console.log(o)
                return c.unshift("fc-day-grid-event", "fc-h-event"), t.isStart && (n = this.getTimeText(t.footprint)) && (h = '<span class="fc-time">' + a.htmlEscape(n) + "</span>"), i = '<span class="fc-title" title="'+ a.htmlEscape(o.miscProps.htitle || "")+'" >' + (a.htmlEscape(o.title || "") || "&nbsp;") + "</span>", '<a class="' + c.join(" ") + '"' + (o.miscProps.hclick ? ' onclick="' + a.htmlEscape(o.miscProps.hclick) + '"' : "") + (o.url ? ' href="' + a.htmlEscape(o.url) + '"' : "") + (p ? ' style="' + p + '"' : "") + '><div class="fc-content">' + (this.dayGrid.isRTL ? i + " " + h : h + " " + i) + "</div>" + (u ? '<div class="fc-resizer fc-start-resizer" />' : "") + (d ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
            }, e
        }(l.default);
        e.default = u
    }, function (t, e, n) {
