...
public class ZipOutput {
	...
	*@Time 19:49
	*/
	public static HttpServletResponse downLoadFiles(List<File> files,String zipPath,HttpServletRequest request, HttpServletResponse response)throws Exception {
		try {
			/**这个集合就是你想要打包的所有文件，这里假设已经准备好了所要打包的文件*/
			//List<File> files = new ArrayList<File>();
			/**创建一个临时压缩文件，我们会把文件流全部注入到这个文件中这里的文件你可以自定义是.rar还是.zip这里的file路径发布到生产环境时可以改为*/
